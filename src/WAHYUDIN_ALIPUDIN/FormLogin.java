...
public class FormLogin extends javax.swing.JFrame { 
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED, new java.awt.Color(0, 102, 102), new java.awt.Color(0, 153, 153)));
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
        ...
        if(txtuser.getText().equals("Wahyudin A") && txtpass.getText().equals("admin")) {
            
            new FormMenu().setVisible(true);
            dispose();
        }else{
            
            JOptionPane.showMessageDialog(this,"password salah !!!","Error message",JOptionPane.ERROR_MESSAGE);
           
            txtuser.setText("Wahyudin A");
            txtpass.setText("");
